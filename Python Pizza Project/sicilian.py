...
s1 = Label(a,text="🍕 Sicilian Pizza 🍕",fg="white",bg="black",font=("Ink Free",35,"bold"))
s1.pack()

s1name = Label(a,text="Name : 🍕 Sicilian Pizza 🍕",fg="white",bg="black",font=("Comic Sans MS",20,"bold"))
...
s1star = Label(a,text="Price (per 1) : 🏷 Rs.560",fg="white",bg="black",font=("Comic Sans MS",20,"bold"))
